...
# jupyter notebook 을 실행한 browser 에서 바로 그림을 볼 수 있게 하는 코드.
# 즉, 브라우저 내부(inline) 에 바로 그려지게 하는 코드.
%matplotlib inline 
...
#7. train/ test/ valid dataset 만들기
train_size = 200000
valid_size = 10000
test_size = 10000
